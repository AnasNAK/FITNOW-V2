                ...
                <div className="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
                        <div className="flex flex-col justify-between lg:py-5">
                            <div>
                                <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-5xl">Welcome To The Second Version Of <span className='text-gray-400'>FITNOW</span> !</h2>
                                <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">FITNOW is the best platform for you to make a workout just at your home  </p>
                                ...
                                <div className="p-6 sm:p-10">
                                    ...
                                    <form onSubmit={handleSubmit} className="mt-4">
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                <label htmlFor="projectBrief" className="text-base font-medium text-gray-900">Password</label>
                                                <div className="mt-2.5 relative">
                                                    <input type='password'
                                                        id="projectBrief"
                                                        name='password'
